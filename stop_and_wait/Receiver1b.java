...
public class Receiver1b extends Thread{
	...
	public Receiver1b(int port) throws IOException{
		...
		while(true){
			...
			try{
	            ...
	            if (sequenceNumber == (expectedSequenceNumber+1)) {
	                ...
	                //Send acknowledgement
	                sendMessage(expectedSequenceNumber, serverSocket, address, port);
	                System.out.println("Server: expected sequence number: " + (expectedSequenceNumber + 1) + " but received " + sequenceNumber + ". DISCARDING");
	            }
